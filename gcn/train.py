...
flags.DEFINE_string('model', 'agcn', 'Model string.')  # 'gcn', 'gcn_cheby', 'dense'
...
flags.DEFINE_float('reg_scalar', 1e-1, 'Initial learning rate.')

# Load data
adj_list, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = load_data(FLAGS.dataset)
