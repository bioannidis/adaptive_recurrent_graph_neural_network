...
from utils import *
from models import GCN, MLP, AGCN, AGRCN
...
flags.DEFINE_float('reg_scalar', 1e-05, 'Weight of smoothness regularizer.')
flags.DEFINE_float('sparse_reg', 0.00017782794100389227, 'Weight of sparsity regularizer.')
